...
export default function UploadForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" className="mt-2 mr-2 py-2 px-3 text-base font-medium text-white focus:outline-none bg-gray-600 rounded-full focus:z-10 focus:ring-4 ">Upload</button>
    </form>
  );
}
